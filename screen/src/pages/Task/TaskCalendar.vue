      ...
      <v-col>
        <v-sheet height="64">
          <v-toolbar flat color="white">
            ...
            <v-spacer></v-spacer>
            <v-btn color="green" depressed dark>Not completed</v-btn>
            <v-btn color="red" depressed dark class="ml-2">Completed</v-btn>
          ...
          >
            <v-card color="grey lighten-4" min-width="350px" flat>
              ...
              <v-card-text>
                ...
                <span v-if="selectedEvent.completed" class="font-weight-bold"
                  >Task Completed<br
                /></span>
                <span
                  >Date:
                  {{ utils.momentFormatDate(false, selectedEvent.start) }}</span
                >
