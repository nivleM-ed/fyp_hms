<template>
  <div class="m-4" ref="ovref">
    ...
    <v-card flat>
      <v-card-title class="headline">Inventory - Food Inventory</v-card-title>
      <v-row>
        <v-col class="col-4">
          <!-- <v-card-title class="headline">Home foods</v-card-title> -->
          <v-list dense>
        ...
        <v-col>
          <v-card height="100%" min-height="60vh">
            ...
            <p v-else class="text-center">
              Click on an food to see the details
            </p>
            <!-- Add to show details of foods -->
          </v-card>
        </v-col>
      </v-row>
      <v-tooltip right>
